...
export default function Toast({
	...
	const bgColors = {
		success: "bg-green-100 border-green-300 dark:bg-green-950 dark:border-green-800",
		error: "bg-red-100 border-red-300 dark:bg-red-950 dark:border-red-800",
		warning: "bg-orange-100 border-orange-300 dark:bg-orange-950 dark:border-orange-800",
