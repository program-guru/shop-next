...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-text-muted bg-surface pt-10">
      <svg
      ...
      >
        ...
        <defs>
          <clipPath id="clip0_8678_1074">
            <rect width="68" height="26" fill="var(--color-surface)" />
          </clipPath>
        </defs>
      </svg>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            ShopNext is a modern e-commerce platform that provides seamless
            shopping experiences with cutting-edge technology and user-friendly
            design.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            ...
            <div className="flex items-center">
              <input
                className="rounded-l-md bg-background outline-none w-full max-w-64 h-11 px-3 border border-border focus:border-primary"
                type="email"
                placeholder="Enter your email"
              />
              <button className="bg-primary hover:bg-primary-dark transition px-4 h-11 text-text-inverse rounded-r-md">
                Subscribe
              </button>
            </div>
          </div>
